...
h5_filename = "../LiF_8x8x8_Kscat-on_intraband-only_Q0000_initialization_S0_100fs_frames.h5"
...
export_diffusion_gif_updated(
    ...
    q_vectors=q_vectors,
    projection=('x', 'y'),
    filename="test1_LiF_8x8x8_Kscat-on_intraband-only_Q0000_initialization_S0_100fs.gif"
)
